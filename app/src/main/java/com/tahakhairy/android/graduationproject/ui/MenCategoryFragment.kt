...
class MenCategoryFragment : Fragment(R.layout.fragment_men) {
    ...
    private fun initData() {
        subCategories.add(SubCategory("Tops"))
        ...
        subCategories.add(SubCategory("Pants"))
        subCategories.add(SubCategory("Men's Accessories"))
        subCategories.add(SubCategory("Shoes"))
        subCategories.add(SubCategory("Coats & Jackets"))
        subCategories.add(SubCategory("Shorts"))
    }
}