...
import com.tahakhairy.android.graduationproject.databinding.FragmentHandmadeBinding
import com.tahakhairy.android.graduationproject.model.SubCategory

class HandmadeCategoryFragment : Fragment(R.layout.fragment_handmade) {

    private lateinit var binding: FragmentHandmadeBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentHandmadeBinding.inflate(inflater, container, false)
        return binding.root
    }
